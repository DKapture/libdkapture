...
int main(int argc, char **argv)
{
    ...
    if (!skel)
    {
        std::cerr << "打开并加载 BPF skeleton 失败" << std::endl;
        return 1;
    }
    ...
    {
        std::cerr << "加载recvmsg kprobe程序失败" << std::endl;
        goto cleanup;
    }
    ...
    if (!send_kprobe_link)
    {
        std::cerr << "加载发送端kprobe程序失败" << std::endl;
        goto cleanup;
    }
    ...
    {
        std::cerr << "加载connect kprobe程序失败" << std::endl;
        goto cleanup;
    }
    ...
    {
        std::cerr << "listen kprobe程序失败" << std::endl;
        goto cleanup;
    }
