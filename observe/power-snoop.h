...
#define POWER_EVENT_MASK_DEVICE_PM     ((1 << POWER_DEVICE_PM_START) | (1 << POWER_DEVICE_PM_END))
#define POWER_EVENT_MASK_PM_QOS        ((1 << POWER_PM_QOS_ADD) | (1 << POWER_PM_QOS_UPDATE))
#define POWER_EVENT_MASK_CLOCK         ((1 << POWER_CLOCK_ENABLE) | (1 << POWER_CLOCK_DISABLE))
#define POWER_EVENT_MASK_RPM           ((1 << POWER_RPM_SUSPEND) | (1 << POWER_RPM_RESUME))
