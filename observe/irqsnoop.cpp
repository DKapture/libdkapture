...
#ifdef BUILTIN
	rb = ring_buffer__new(bpf_map__fd(obj->maps.irq_map), (ring_buffer_sample_fn)cb, ctx, NULL);
#else
	rb = ring_buffer__new(bpf_map__fd(obj->maps.irq_map), handle_event, NULL, NULL);
#endif
	if (!rb)
	{
