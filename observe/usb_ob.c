...
const char argp_program_doc[] = "Summarize usb_ob times as a histogram.\n"
								"\n"
								"USAGE: usb_ob [--help] [-p PID] [-c CG]\n"
								"\n"
								"EXAMPLES:\n"
								"    usb_ob         # summarize  usb_ob times "
								"as a histogram\n"
								"    usb_ob -p 185  # trace PID 185 only\n"
								"    usb_ob -c CG   # Trace process under "
								"cgroupsPath CG\n";
