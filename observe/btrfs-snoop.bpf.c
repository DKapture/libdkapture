...
int tp_btrfs_add_reclaim_block_group(struct tp_btrfs_add_reclaim_block_group_t *ctx)
{
...
int tp_btrfs_add_unused_block_group(struct tp_btrfs_add_unused_block_group_t *ctx)
{
...
int tp_btrfs_done_preemptive_reclaim(struct tp_btrfs_done_preemptive_reclaim_t *ctx)
{
...
int tp_btrfs_get_extent_show_fi_inline(struct tp_btrfs_get_extent_show_fi_inline_t *ctx)
{
...
int tp_btrfs_get_extent_show_fi_regular(struct tp_btrfs_get_extent_show_fi_regular_t *ctx)
{
...
int tp_btrfs_inode_mod_outstanding_extents(struct tp_btrfs_inode_mod_outstanding_extents_t *ctx)
{
...
int tp_btrfs_ordered_extent_dec_test_pending(struct tp_btrfs_ordered_extent_dec_test_pending_t *ctx)
{
...
int tp_btrfs_ordered_extent_lookup_first(struct tp_btrfs_ordered_extent_lookup_first_t *ctx)
{
...
int tp_btrfs_ordered_extent_lookup_first_range(struct tp_btrfs_ordered_extent_lookup_first_range_t *ctx)
{
...
int tp_btrfs_ordered_extent_lookup_for_logging(struct tp_btrfs_ordered_extent_lookup_for_logging_t *ctx)
{
...
int tp_btrfs_ordered_extent_lookup_range(struct tp_btrfs_ordered_extent_lookup_range_t *ctx)
{
...
int tp_btrfs_ordered_extent_mark_finished(struct tp_btrfs_ordered_extent_mark_finished_t *ctx)
{
...
int tp_btrfs_qgroup_account_extents(struct tp_btrfs_qgroup_account_extents_t *ctx)
{
...
int tp_btrfs_reserve_extent_cluster(struct tp_btrfs_reserve_extent_cluster_t *ctx)
{
...
int tp_btrfs_set_lock_blocking_read(struct tp_btrfs_set_lock_blocking_read_t *ctx)
{
...
int tp_btrfs_set_lock_blocking_write(struct tp_btrfs_set_lock_blocking_write_t *ctx)
{
...
int tp_btrfs_skip_unused_block_group(struct tp_btrfs_skip_unused_block_group_t *ctx)
{
...
int tp_btrfs_tree_read_unlock_blocking(struct tp_btrfs_tree_read_unlock_blocking_t *ctx)
{
...
int tp_btrfs_truncate_show_fi_inline(struct tp_btrfs_truncate_show_fi_inline_t *ctx)
{
...
int tp_btrfs_truncate_show_fi_regular(struct tp_btrfs_truncate_show_fi_regular_t *ctx)
{
...
int tp_find_free_extent_have_block_group(struct tp_find_free_extent_have_block_group_t *ctx)
{
...
int tp_find_free_extent_search_loop(struct tp_find_free_extent_search_loop_t *ctx)
{
...
int tp_qgroup_meta_free_all_pertrans(struct tp_qgroup_meta_free_all_pertrans_t *ctx)
{
