...
int tp_ext4_alloc_da_blocks(struct tp_ext4_alloc_da_blocks_t *ctx)
{
    ...
    DEBUG(0, "dev: %d, ino: %lu, data_blocks: %u",
        ctx->dev, ctx->ino, ctx->data_blocks);
    event.dev = ctx->dev;
    event.ino = ctx->ino;
...
int tp_ext4_begin_ordered_truncate(struct tp_ext4_begin_ordered_truncate_t *ctx)
{
    ...
    event.base.tid = (pid_t)bpf_get_current_pid_tgid();
    bpf_get_current_comm(&event.base.comm, sizeof(event.base.comm));
    DEBUG(0, "dev: %d, ino: %lu, new_size: %llu",
        ctx->dev, ctx->ino, ctx->new_size);
    event.dev = ctx->dev;
    event.ino = ctx->ino;
...
int tp_ext4_collapse_range(struct tp_ext4_collapse_range_t *ctx)
{
    ...
    event.base.tid = (pid_t)bpf_get_current_pid_tgid();
    bpf_get_current_comm(&event.base.comm, sizeof(event.base.comm));
    DEBUG(0, "dev: %d, ino: %lu, offset: %llu, len: %llu",
        ctx->dev, ctx->ino, ctx->offset, ctx->len);
    event.dev = ctx->dev;
    event.ino = ctx->ino;
...
int ext4_da_release_space(struct tp_ext4_da_release_space_t *ctx)
{
    ...
    event.base.tid = (pid_t)bpf_get_current_pid_tgid();
    bpf_get_current_comm(&event.base.comm, sizeof(event.base.comm));
    DEBUG(0, "dev: %d, ino: %lu i_blocks: %llu, freed_blocks: %d"
...
int tp_ext4_da_reserve_space(struct tp_ext4_da_reserve_space_t *ctx)
{
    ...
    event.base.tid = (pid_t)bpf_get_current_pid_tgid();
    bpf_get_current_comm(&event.base.comm, sizeof(event.base.comm));
    DEBUG(0, "dev: %d, ino: %lu, i_blocks: %llu, reserved_data_blocks: %d, mode: %u",
        ctx->dev, ctx->ino, ctx->i_blocks, ctx->reserved_data_blocks, ctx->mode);
    event.dev = ctx->dev;
    event.ino = ctx->ino;
    event.i_blocks = ctx->i_blocks;
    event.reserved_data_blocks = ctx->reserved_data_blocks;
...
int tp_ext4_da_write_pages(struct tp_ext4_da_write_pages_t *ctx)
{
    ...
    event.base.tid = (pid_t)bpf_get_current_pid_tgid();
    bpf_get_current_comm(&event.base.comm, sizeof(event.base.comm));
    DEBUG(0, "dev: %d, ino: %lu, first_page: %lu, nr_to_write: %ld, sync_mode: %d",
        ctx->dev, ctx->ino, ctx->first_page, ctx->nr_to_write, ctx->sync_mode);
    event.dev = ctx->dev;
    event.ino = ctx->ino;
...
int tp_ext4_da_write_begin(struct tp_ext4_da_write_begin_t *ctx)
{
    ...
    event.base.tid = (pid_t)bpf_get_current_pid_tgid();
    bpf_get_current_comm(&event.base.comm, sizeof(event.base.comm));
    DEBUG(0, "dev: %d, ino: %lu, pos: %lld, len: %u",
        ctx->dev, ctx->ino, ctx->pos, ctx->len);
    event.dev = ctx->dev;
    event.ino = ctx->ino;
    event.pos = ctx->pos;
    event.len = ctx->len;
...
int tp_ext4_da_write_end(struct tp_ext4_da_write_end_t *ctx)
{
    ...
    event.base.tid = (pid_t)bpf_get_current_pid_tgid();
    bpf_get_current_comm(&event.base.comm, sizeof(event.base.comm));
    DEBUG(0, "dev: %d, ino: %lu, pos: %lld, len: %u, copied: %u",
        ctx->dev, ctx->ino, ctx->pos, ctx->len, ctx->copied);
    event.dev = ctx->dev;
    event.ino = ctx->ino;
    event.pos = ctx->pos;
    event.len = ctx->len;
...
int tp_ext4_allocate_inode(struct tp_ext4_allocate_inode_t *ctx)
{
    ...
    event.base.tid = (pid_t)bpf_get_current_pid_tgid();
    bpf_get_current_comm(&event.base.comm, sizeof(event.base.comm));
    DEBUG(0, "dev: %d, ino: %lu, dir: %lu, mode: %o",
        ctx->dev, ctx->ino, ctx->dir, ctx->mode);
    event.dev = ctx->dev;
    event.ino = ctx->ino;
    event.dir = ctx->dir;
    event.mode = ctx->mode;
...
int tp_ext4_da_update_reserve_space(struct tp_ext4_da_update_reserve_space_t *ctx)
{
...
int tp_ext4_es_find_extent_range_enter(struct tp_ext4_es_find_extent_range_enter_t *ctx)
{
...
int tp_ext4_es_find_extent_range_exit(struct tp_ext4_es_find_extent_range_exit_t *ctx)
{
...
int tp_ext4_es_insert_delayed_block(struct tp_ext4_es_insert_delayed_block_t *ctx)
{
...
int tp_ext4_ext_convert_to_initialized_enter(struct tp_ext4_ext_convert_to_initialized_enter_t *ctx)
{
...
int tp_ext4_ext_convert_to_initialized_fastpath(struct tp_ext4_ext_convert_to_initialized_fastpath_t *ctx)
{
...
int tp_ext4_ext_handle_unwritten_extents(struct tp_ext4_ext_handle_unwritten_extents_t *ctx)
{
...
int tp_ext4_get_implied_cluster_alloc_exit(struct tp_ext4_get_implied_cluster_alloc_exit_t *ctx)
{
...
int tp_ext4_journalled_invalidate_folio(struct tp_ext4_journalled_invalidate_folio_t *ctx)
{
...
int tp_ext4_mb_discard_preallocations(struct tp_ext4_mb_discard_preallocations_t *ctx)
{
...
int tp_ext4_other_inode_update_time(struct tp_ext4_other_inode_update_time_t *ctx)
{
